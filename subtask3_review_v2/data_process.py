'''
similar to data_process.py, but we dont have to extract the images and tables here
as we will use pdffigures2 to extract the images and tables, seperately
...
def main():
    ...
    parser.add_argument("--root_dir", type=str, default="./subtask3_review_v2")
    parser.add_argument("--root_input_dir", type=str, default="./subtask3_review", help="the root directory of the input text data")
    parser.add_argument("--target_dir", type=str, default="./subtask3_review_v2/processed", help="the directory to save the processed data")
    ...
    for conf_json_file in all_conf_json_data_files:
        ...
        input_text_dir = os.path.join(args.root_input_dir, "our_dataset", conf_name, f"{conf_name}_paper")
        # ./subtask3_review/our_dataset/ICLR_2022/ICLR_2022_pdf
        pdf_dir = os.path.join(args.root_input_dir, "our_dataset", conf_name, f"{conf_name}_pdf")
        meta_csv_dir = os.path.join(args.root_dir, f"{conf_name}_draft_comment.csv")
        ...
        for paper_data in tqdm(conf_json_data):
            ...
            # TODO: will run the pdffigures2 to extract the figures and tables
