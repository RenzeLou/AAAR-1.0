...
# append AI-scientist path
sys.path.append("/data/rml6079/projects/scientific_doc/AI-Scientist/")
...
def main():
    ...
    for input_piece in tqdm(processed_input_list):
        ...
        #     temperature=0.1,
        # )
        # score = review["Overall"]  # overall score 1-10
        # decision = review["Decision"]  # ['Accept', 'Reject']
        # weakness_list = review["Weaknesses"]  # List of weaknesses (str)
        ...
        while flag:
            try:
                ...
                if retry_cnt > MAX_RETRY:
                    print(f"==> max retry reached for {input_piece['id']}")
                    weakness_list = [] # empty list
                    flag = False
                else:
                    # sleep for a while
                    time.sleep(2.5)
