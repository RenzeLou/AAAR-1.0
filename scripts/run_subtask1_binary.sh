...
python scripts/subtask1_equation_model_eval_binary.open_source.py \
    --api_name ${model} \
    --template 1 \
    --root_dir './temp/subtask1_equation_unified' \
    --eval_data_file '1049.human_filter.json' \
    --save_dir './temp/subtask1_equation_unified/eval_results_binary' \
